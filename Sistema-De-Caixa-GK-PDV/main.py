...
def cadastro():
    ...
    btn_salvar = ctk.CTkButton(master=frame_cadastro, text="Salvar",width=450,height=50, command=salvar_mon, fg_color=azul,corner_radius=20,text_color="white",font=("Arial Bold",18))
